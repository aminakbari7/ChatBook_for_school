...
<form action="{{URL('teachers/tsearch')}}" style="background-color: #1ca9c9"">
    ...
    <table class="fl-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> {{ $teacher->phone }}</td>
                <td>{{ $teacher->email }}</td>
                <td style="width: 5%">{{ $teacher->created_at}}</td>
                <td style="color: red;font-size:15px;">
                    <a href="{{URL('teachers/destroy',$teacher)}}"><b style="background-color:rgb(235, 220, 220) ! important">حذف </b></a>
                </td>
                <td style="color: rgb(58, 3, 255);font-size:20px;">
                    <a href="{{URL('teachers/edteacher',$teacher)}}"><b style="background-color:rgb(235, 220, 220) ! important">ویرایش</b></a>
                </td>
                </tr>
                @php $i++;@endphp
        @endforeach
