  ...
  <div class="app-modal" data-name="delete">
      <div class="app-modal-container">
          <div class="app-modal-card" data-name="delete" data-modal='0'>
              <div class="app-modal-header">آیا مطمئن هستید  حذف کنید؟</div>
              <div class="app-modal-body">بعد از حذف اطلاعات دیگر قابل برگشت نیست</div>
              <div class="app-modal-footer">
                  <a href="javascript:void(0)" class="app-btn cancel">انصراف</a>
                  <a href="javascript:void(0)" class="app-btn a-btn-danger delete">ثبت حذف</a>
              </div>
          </div>
      </div>
  </div>
          ...
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      {{-- Dark/Light Mode  --}}
                      <p class="divider"></p>
                      <p class="app-modal-header">تم مشکی <span class="
                  ...
                  <div class="app-modal-footer">
                      <a href="javascript:void(0)" class="app-btn cancel">انصراف</a>
                      <input type="submit" class="app-btn a-btn-success update" value="ثبت"  />
                  </div>
              </form>
          </div>
      </div>
