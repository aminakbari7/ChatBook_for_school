<x-app-layout>
    <style>
        *{
        ...
        <form action="{{URL('parents/psearch')}}" style="background-color: #1ca9c9">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="color: red;font-size:15px;">
                        <a href="{{URL('parents/destroyp',$parent)}}"><b style="background-color:rgb(235, 220, 220) ! important">حذف </b></a>
                    </td>
                    <td style="color: rgb(58, 3, 255);font-size:14px;">
                        <a href="{{URL('parents/edparent',$parent)}}"><b style="background-color:rgb(235, 220, 220) ! important">ویرایش</b></a>
                    </td>
                    </tr>
                    @php $i++;@endphp
            @endforeach
